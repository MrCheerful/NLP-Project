...
1. intersect with alias list to see which aliases are actually used

2. intersect with bad words list to see which bad word are used, and remove the bad words
...
```{r}
dictionaryWordsVector <- bigworddf$word[1:1000]
